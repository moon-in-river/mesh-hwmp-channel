...
void MeshTest::InstallInternetStack () {
    //configure OLSR
    OlsrHelper olsr;
    olsr.Set ("HelloInterval", TimeValue (Seconds (3)));
...
int MeshTest::Run () {
    ...
    //NetAnim
    AnimationInterface anim ("output/xml/hao-olsr.xml");
