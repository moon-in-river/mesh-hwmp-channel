...
void MeshTest::CreateNodes () {
    ...
    // Config::SetDefault ("ns3::dot11s::PeerManagementProtocol::EnableBeaconCollisionAvoidance", BooleanValue (false)); // can't be change
